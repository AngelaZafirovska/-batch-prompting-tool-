      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <form onSubmit={handleSubmit} className="card p-4 shadow">
            ...
            <div className="mb-3 row">
              <div className="col-md-6">
                <label className="form-label">Anchor Text <br />(One per line)</label>
              </div>
              <div className="col-md-6">
                    <textarea
                      className="form-control"
                      ...
                      onChange={handleChange}
                    />
                    {errors.vs2 && <span style={{ color: 'red' }}>{errors.vs2}</span>}
              </div>
            </div>
            <div className="mb-3 row">
              <div className="col-md-6">
                <label className="form-label">Power Page URLs <br />(One per line)</label>
              </div>
              <div className="col-md-6">
                  <textarea
                    className="form-control"
            ...
            <div className="mb-3 row">
              <div className="col-md-6">
                <label className="form-label">Template Name (Optional): <br /> <p style={{ fontSize: "13px"}}>Add a name to save the <br />prompt as a template</p></label>
              </div>
              <div className="col-md-6">
                    <input
                      className="form-control"
            ...
            <button type="submit" className="btn btn-primary w-100">Process</button>
          </form>
        </div>
        <div className="col-md-4"></div>
      </div>
